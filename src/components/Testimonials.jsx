...
const Testimonials = () => (
    <section id='client' className={`${styles.paddingY} flex-col relative`}>
      ...
      <div className='w-full flex justify-between items-center md:flex-row sm:mb-16 mb-6 relative z-[1]'>
        ...
        <div className='w-full md:mt-0 mt-6'>
          <p className={`${styles.paragraph} text-left max-w-[450px] `}>Duis do sunt ad aliqua ad Consectetur et adipisicing incididunt eu.</p>
        </div>
      </div>
